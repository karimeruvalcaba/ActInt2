...
TEST(test_lineal_search, test_1_lineal_search)
{
    ...
    ASSERT_EQ(LinealSearch::Find(centrals, new_contract), make_pair(5, 5));
}
...
TEST(test_lineal_search, test_2_lineal_search)
{
    ...
    ASSERT_EQ(LinealSearch::Find(centrals, new_contract), make_pair(3, 4));
}
...
TEST(test_lineal_search, test_4_lineal_search)
{
    ...
    ASSERT_EQ(LinealSearch::Find(centrals, new_contract), make_pair(200, 200));
}